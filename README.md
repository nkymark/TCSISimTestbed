...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-149457407-3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-149457407-3');
</script>
...
<img src="/Figures/BlockDiagram.png" width="700">
...
<img src="/Figures/faultfree.png" width="400" height="300">&emsp;<img src="/Figures/paf.png" width="400" height="300">
